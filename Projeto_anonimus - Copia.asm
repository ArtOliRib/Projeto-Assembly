...
censurar:
    ...
    mov eax, DWORD PTR [ebp+12] ;larguraImagem
    mov DWORD PTR [ebp-4], eax
    mov eax, DWORD PTR [ebp+8] ; largura da censura
    mov DWORD PTR [ebp-8], eax
    mov eax, DWORD PTR [ebp +4] ;coordenada X
...
loopLinha:
    ...
    invoke ReadFile, inputFileHandle, addr fileBuffer, larguraImagem, addr readCount, NULL
...
escrita:
    ...
    invoke WriteFile, outputFileHandle, addr fileBuffer, larguraImagem, addr writeCount, NULL
    jmp loopLinha
